...
var SequenceMatcherModel = (function () {
    ...
    SequenceMatcherModel.prototype._chainB = function () {
        var b, elt, i, indices, isjunk, _i, _j, _len, _len1, _ref;
        b = this.b;
        this.b2j = {};
...
var SnapshotJSInner = (function (_super) {
    ...
    SnapshotJSInner.prototype.toMatchSnapshot = function (snapshot) {
        var prettyActual = this.actual ? (0, vkbeautify_1.json)(this.getOrderedStringifyAndClean()) : "";
        ...
        if (snapshot === null || snapshot === undefined) {
            ...
            prettySnapshot = auto_snapshot ? (0, vkbeautify_1.json)(auto_snapshot) : "";
        }
        else {
            prettySnapshot = snapshot ? (0, vkbeautify_1.json)(snapshot) : snapshot;
        }
